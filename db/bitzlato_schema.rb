...
ActiveRecord::Schema.define(version: 2021_12_16_093540) do
  ...
  create_table "user_2fa", force: :cascade do |t|
    t.integer "user_id", null: false
    t.string "secret", limit: 20, null: false
    t.datetime "created_at", null: false
    t.index ["user_id"], name: "users_2fa_user_id_key", unique: true
  end
  ...
  create_table "p2p.user_profile", force: :cascade do |t|
    t.string "lang", limit: 2, null: false
    t.integer "user_id", null: false
    t.string "currency", limit: 5, null: false
    t.string "cryptocurrency", limit: 256, null: false
    t.datetime "start_of_use_date", default: -> { "now()" }
    t.decimal "rating", null: false
    t.datetime "lastactivity", default: -> { "now()" }, null: false
    t.boolean "blocked_by_admin", default: false, null: false
    t.string "old_trade_status", limit: 256, default: "some", null: false
    t.boolean "cancreateadvert_status"
    t.string "cancreateadvert_reason", limit: 256
    t.boolean "verified", default: false, null: false
    t.text "about_user", default: ""
    t.string "telegram_name"
    t.text "user_info"
    t.boolean "licensing_agreement_accepted", default: false, null: false
    t.text "greeting"
    t.boolean "safe_mode_enabled", default: true, null: false
    t.boolean "pass_safety_wizard", default: false, null: false
    t.boolean "suspicious", default: false, null: false
    t.decimal "copilka"
    t.boolean "merged", default: false, null: false
    t.string "public_name", limit: 28
    t.string "lang_web", limit: 2
    t.datetime "verification_date"
    t.boolean "accept_marketing_emails", default: true, null: false
    t.string "generated_name", limit: 28, null: false
    t.string "phone", limit: 20
    t.boolean "is_muted", default: false, null: false
    t.string "timezone", limit: 100
    t.boolean "pass_merge_wizard", default: false, null: false
    t.integer "safetyIndex_modifier", default: 0, null: false
    t.string "avatar", limit: 40
    t.boolean "self_frozen", default: false, null: false
    t.index ["generated_name"], name: "user_profile_generated_name_key", unique: true
    t.check_constraint "length(generated_name::text) > 0", name: "user_profile_generated_name_check"
    t.check_constraint "length(public_name::text) > 0", name: "user_profile_public_name_check"
  end
  ...
  add_foreign_key "user_2fa", "\"user\"", column: "user_id", name: "users_2fa_user_id_fkey"
